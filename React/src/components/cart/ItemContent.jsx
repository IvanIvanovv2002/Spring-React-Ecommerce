        ...
        <div className="grid md:grid-cols-5 grid-cols-4 md:text-md text-sm gap-4   items-center  border border-slate-200  rounded-md  lg:px-4  py-4 p-2">
            <div className="md:col-span-2 justify-self-start flex  flex-col gap-2 ">
                ...
                <div className="md:w-36 sm:w-24 w-12">
                    <img className="md:h-36 sm:h-24 h-12 w-full object-cover rounded" src={image} alt={productName}/>
                ...
                <div className="flex items-start gap-5 mt-3">
                    ...
                    px-4 py-1 text-xs border-rose-600 text-rose-600 rounded-md hover:bg-red-50 transition-colors duration-200">
                        <HiOutlineTrash className="text-rose-600" size={16} />
                        Remove
                    </button>
                </div>
                </div>
            ...
            <div className="justify-self-center lg:text-[17px] text-sm text-slate-600 font-semibold">
                <SetQuantity quantity={currentQuantity} cardCounter={true} handleQtyIncrease={() => handleQuantityIncrease({
                    image,
                    productName,
                    description,
                    specialPrice,
