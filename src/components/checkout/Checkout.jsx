...
const Checkout = () => {
  ...
  const steps = ["Address Details", "Payment Details", "Review Your Order", "Payment"]  
  ...
  const handleNext = () => {
    if (activeStep === 0 && !selectedUserCheckoutAddress) {
      toast.error('Please, select address before proceeding')
      return;
    }
      ...
      <div 
        ...
        style={{ boxShadow: "0 -2px 4px rgba(100, 100, 100, 0.15)" }}>
          ...
          {activeStep !== steps.length - 1 && (
            ...
            }`} onClick={handleNext} >Proceed</button>
          )}
      </div>
